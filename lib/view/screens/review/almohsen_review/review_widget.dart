...
class ReviewWidgetAlmohsen extends StatelessWidget {
  final ReviewModel? reviewModel;
  const ReviewWidgetAlmohsen({Key? key, required this.reviewModel}) : super(key: key);
        ...
        Row(children: [
          ClipRRect(
            ...
            child: FadeInImage.assetNetwork(
              placeholder: Images.placeholderImage, height: Dimensions.imageSize,
              width: Dimensions.imageSize, fit: BoxFit.cover,
              image: '${Provider.of<SplashProvider>(context, listen: false).baseUrls!.customerImageUrl}/${
                  reviewModel!.customer != null ? reviewModel!.customer!.image : ''
              }',
              imageErrorBuilder: (c, o, s) => Image.asset(Images.placeholderImage, height: Dimensions.imageSize,
                  width: Dimensions.imageSize, fit: BoxFit.cover),
            ),
          ),
