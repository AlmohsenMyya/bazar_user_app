...
class Customer {
  ...
  Customer.fromJson(Map<String, dynamic> json) {
    ...
    _phone = json['phone'];
    // almohsen
    // _averageReview = (json['rating']['avg']).toString();
    _image = json['image'];
    _email = json['email'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['email'] = _email;
    //almohsen
    // data ['rating']['avg'] = _averageReview ;
    ...
    // if (_rating != null) {data['rating'] = _rating!.toJson();}
...
class Rating {
  ...
  Rating({required this.id, required this.sellerId, required this.customerId, required this.avg});
